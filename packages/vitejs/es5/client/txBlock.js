...
var Tx = (function () {
    ...
    Tx.prototype.createContract = function (_a, requestType) {
        var accountAddress = _a.accountAddress, _b = _a.tokenId, tokenId = _b === void 0 ? vitejs_constant_1.Vite_TokenId : _b, _d = _a.amount, amount = _d === void 0 ? '0' : _d, _e = _a.fee, fee = _e === void 0 ? '10000000000000000000' : _e, _f = _a.times, times = _f === void 0 ? 0 : _f, hexCode = _a.hexCode, abi = _a.abi, params = _a.params, height = _a.height, prevHash = _a.prevHash, _g = _a.confirmTimes, confirmTimes = _g === void 0 ? 0 : _g;
