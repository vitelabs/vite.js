...
var ClientClass = (function (_super) {
    ...
    ClientClass.prototype.sendTx = function (accountBlock, privateKey) {
        return __awaiter(this, void 0, void 0, function () {
            var _accountBlock;
            return __generator(this, function (_b) {
                _accountBlock = vitejs_accountblock_1.signAccountBlock(accountBlock, privateKey);
                return [2, this.sendRawTx(_accountBlock)];
            });
        });
    };
    ClientClass.prototype.sendAutoPowTx = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        powTx = _d.sent();
                        return [2, this.sendTx(powTx.accountBlock, privateKey)];
                }
            });
        });
    };
    ClientClass.prototype.sendRawTx = function (accountBlock) {
        return __awaiter(this, void 0, void 0, function () {
            var err_1, _err;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4, this.tx.sendRawTx(accountBlock)];
                    case 1:
                        _b.sent();
