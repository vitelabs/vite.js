...
function encodeParameter(typeStr, params) {
    ...
    if (typeObj.isArr && !vitejs_utils_1.isArray(params)) {
        try {
            ...
            if (!vitejs_utils_1.isArray(params)) {
...
function encodeParameters(types, params) {
    ...
    if (!vitejs_utils_1.isArray(params) || types.length !== params.length) {
...
function decodeParameters(types, params) {
    ...
    types.forEach(function (type) {
        ...
        if (!typeObj.isDynamic && typeObj.isArr) {
            var len_1 = 0;
            typeObj.arrLen.forEach(function (_l) {
                len_1 += _l * typeObj.byteLength;
            });
            var _p = _params.slice(0, len_1 * 2);
            _params = _params.slice(len_1 * 2);
            resArr.push({
                isDynamic: false,
        ...
        var _res = decode.number({ type: 'number', typeStr: 'uint', byteLength: 32, isArr: false }, _params);
