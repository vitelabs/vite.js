...
function encodeFunction(jsonFunction, methodName) {
    var isArr = vitejs_utils_1.isArray(jsonFunction);
    var _jsonFunction = isArr ? getFunction(jsonFunction, methodName) : jsonFunction;
...
function getFunction(jsonFunction, methodName) {
